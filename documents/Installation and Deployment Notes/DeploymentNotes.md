...
Select the correct version of MongoDB. We're using MongoDB version 8.2.1 on the Debian 22.04 x64 platform, server package. The provided link will download the appropriate package.
...
Create an executable of the startmongodb.sh script:
